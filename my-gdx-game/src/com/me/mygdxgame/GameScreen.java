...
public class GameScreen extends BasicScreen{
	...
	public GameScreen(){
		super(480, 800, new TextureRegion(AssetsManager.get().getTexture("data/background_game.png"), 0, 0, 480, 800));
		loadAnimation("spuzregmover", "data/Spuzzy_Regular_Spreadsheet.png", 0, 0, 128, 128, 5, 0.125f);
		loadAnimation("spuzregmoveb", "data/Spuzzy_Regular_Spreadsheet.png", 0, 128, 128, 128, 5, 0.125f);
		loadAnimation("spuzregmovey", "data/Spuzzy_Regular_Spreadsheet.png", 0, 256, 128, 128, 5, 0.125f);
		loadAnimation("spuzregdeadr", "data/Spuzzy_Regular_Spreadsheet.png", 0, 384, 128, 128, 7, 0.125f);
		loadAnimation("spuzregdeadb", "data/Spuzzy_Regular_Spreadsheet.png", 0, 512, 128, 128, 7, 0.125f);
		loadAnimation("spuzregdeady", "data/Spuzzy_Regular_Spreadsheet.png", 0, 640, 128, 128, 7, 0.125f);
